import type { WorkbookSnapshot } from './sync-server-test-helpers.js'
import {
  Effect,
  ...
  expect,
  it,
  readMcpServerCardToolNames,
  readMcpToolAnnotations,
  readMcpToolNames,
  resolveCanonicalDocsRedirectUrl,
  startHttpServer,
  upstreamServers,
  vi,
} from './sync-server-test-helpers.js'

describe('sync-server proxy, app, MCP, and health routes', () => {
