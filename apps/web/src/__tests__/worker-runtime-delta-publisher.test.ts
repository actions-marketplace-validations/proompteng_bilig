...
const CHANGED_CELL_CONTENT_DIRTY_MASK = DirtyMaskV3.Value | DirtyMaskV3.Text
...
describe('WorkerRuntimeDeltaPublisher', () => {
  it('builds sheet-level workbook delta batches from engine impact', () => {
    ...
    expect([...sheet1.dirty.cellRanges]).toEqual([3, 3, 4, 4, CHANGED_CELL_CONTENT_DIRTY_MASK, 1, 2, 1, 2, RANGE_VISUAL_DIRTY_MASK])
