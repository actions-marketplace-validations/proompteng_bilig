...
[WorkbookGridSurface.tsx](../packages/grid/src/WorkbookGridSurface.tsx),
...
- WebGPU renders the workbook rect plane through
  [GridGpuSurface.tsx](../packages/grid/src/GridGpuSurface.tsx).
- Visible text is rendered by
  [GridTextOverlay.tsx](../packages/grid/src/GridTextOverlay.tsx)
  from the scene produced by
  [gridTextScene.ts](../packages/grid/src/gridTextScene.ts).
- Selection, fill, resize, hover, and header chrome are assembled in
  [gridGpuScene.ts](../packages/grid/src/gridGpuScene.ts).
- Workbook behavior is coordinated by
  [WorkbookView.tsx](../packages/grid/src/WorkbookView.tsx)
  and
  [WorkbookGridSurface.tsx](../packages/grid/src/WorkbookGridSurface.tsx).
